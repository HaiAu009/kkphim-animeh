...
use KKPhim\ThemeAnimeH\Controllers\ThemeAnimeHController;
...
Route::group([
    ...
    Route::post(sprintf('/%s/{movie}/{episode}/report', config('kkphim.routes.movie', 'phim')), [ThemeAnimeHController::class, 'reportEpisode'])->name('episodes.report');
    Route::post(sprintf('/%s/{movie}/rate', config('kkphim.routes.movie', 'phim')), [ThemeAnimeHController::class, 'rateMovie'])->name('movie.rating');
